                        ...
                        <div style="width: 500px" class="classification-input-component" id='1'>
                            ...
                            <div style="display: flex; justify-content: space-between;">
                                ...
                                <div class="slider-container">
                                    <input  id="classification-slider" type="range" min="0" max="100" value="50" step='5' name="{{ $classification->name }}" class="classification-slider scrollClass" oninput="handleInput(this.value, this)">
                                </div>
                                <div>
