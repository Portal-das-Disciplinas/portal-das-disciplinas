                        ...
                        <div class="card mt-5 px-2 py-2">
                            ...
                            <div class="form">
                                ...
                                <div class="mt-1 d-flex flex-column" style="border-bottom: solid 1px rgba(0,0,0,0.2)">
                                    <button id="btnSearchDisciplineData" class="btn btn-primary mb-4" onclick="onSearchDisciplineDataClick('{{ $discipline->code }}')">Buscar
                                        dados</button>
                                    <small id="infoBtnSearchDisciplineData" class=" ml-3 text-info d-none" style="text-align:center">Altere a data ou marque/desmarque a opção "Todos os
...
<div id="modal-new-subject-topic" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div id="feedback-new-topic" class="d-none alert alert-dismissible  fade" role="alert">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="saveTopic(event)">Salvar</button>
