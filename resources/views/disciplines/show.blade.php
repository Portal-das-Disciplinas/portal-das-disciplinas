...
@section('description')
    @if (isset($discipline->professor->name))
        {{ $discipline->name }} - {{ $discipline->code }}, tutorado por {{ $discipline->professor->name }}. Clique para
        saber
        mais.
    @else
                ...
                <div class="row">
                    <div class='col-md-8'>
                        ...
                        <div class='section'>
                            ...
                            @if (
                                $discipline->hasMediaOfType(\App\Enums\MediaType::VIDEO) &&
                                    ...
                                    <div class="row d-flex align-items-center">
                                        <div class="d-flex col-md-12">
                                            <span class='d-flex justify-content-start'
                                                style='width:15%'><b>{{ $discipline->getClassificationsValues($classification->id) }}%</b></span>
                        ...
                        <div>
                            ...
                            @if (
                                ...
                                <audio class="w-100" controls="controls">
                                    <source
                                        src="{{ $discipline->getMediasByType(\App\Enums\MediaType::PODCAST)->first()->view_url }}"
                                        type="audio/mp3" />
                                    seu navegador não suporta HTML5
                                </audio>
                            @else
                                <img class="img-fluid light-border-radius" src="{{ asset('img/nopodcast.png') }}"
                                    alt="Sem podcast">
                            @endif
                        </div>
                        <hr>
                                    ...
                                    @foreach ($discipline->faqs as $faq)
                                        <div class="w-100 card mb-3 text-dark " style='border:1px solid #014C8C;'>
                                            <div class="card-header" id="faq-header-{{ $faq->id }}"
                                                data-toggle="collapse" data-target="#faq-content-{{ $faq->id }}">
                                                <h5 class="mb-0 d-flex justify-content-between">
                                                    ...
                                                    @if (isset($can) && $can)
                                                        <form
                                                            action=" {{ route('disciplinas.faqs.destroy', [$discipline->id, $faq->id]) }}"
                                            ...
                                            <div id="faq-content-{{ $faq->id }}" class="collapse"
                                                aria-labelledby="faq-header-{{ $faq->id }}" data-parent="#faqs">
                                                <div class="card-body">
                                                    {!! $faq->content !!}
                                                </div>
                                            </div>
                    ...
                    <div class="section">
                        <div class="card mt-5 px-2 py-2">
                            ...
                            <div class="form">
                                <div id="semesterSelectFields" class="form-group" style="opacity: 50%" ;>
                                    <div class="row d-flex align-items-end">
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control form-control-sm disabled" id="yearStart"
                                                name="yearStart" onchange="onChangeSelect(event)" disabled>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="periodStart" name="periodStart"
                                                class="form-control form-control-sm" onchange="onChangeSelect(event)"
                                                disabled>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control form-control-sm" id="yearEnd" name="yearEnd"
                                                onchange="onChangeSelect(event)" disabled>
                                                @for ($i = $actualYear; $i > 2000; $i--)
                                                    <option value='{{ $i }}'>{{ $i }}</option>
                                                @endfor
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="periodEnd" name="periodEnd" class="form-control form-control-sm"
                                                onchange="onChangeSelect(event)" disabled>
                                                <option value=1>1</option>
                                                <option value=2>2</option>
                                                <option value=3>3</option>
                                ...
                                <div>
                                    <input id="checkAllPeriods" name="checkAllPeriods" type="checkbox" checked
                                        onchange="onChangeCheckAllPeriods(event)">
                                ...
                                <div class="mt-1 d-flex flex-column" style="border-bottom: solid 1px rgba(0,0,0,0.2)">
                                    <button id="btnSearchDisciplineData" class="btn btn-primary mb-4"
                                        onclick="onSearchDisciplineDataClick('{{ $discipline->code }}')">Buscar
                                        dados</button>
                                    <small id="infoBtnSearchDisciplineData" class=" ml-3 text-info d-none"
                                        style="text-align:center">Altere a data ou marque/desmarque a opção "Todos os
                                        períodos" para fazer uma nova busca.</small>
                                </div>

                                <div class="mt-3 px-1 d-flex flex-column"
                                    style="border:solid 1px rgba(0,0,0,0.2); border-radius: 5px;">
                                    <div>
                                        <input id="checkOnlyProfessorClasses" name="onlyProfessorClasses" type="checkbox"
                                            checked onchange="onChangeAllClasses(event)">
                                        <label for="checkOnlyProfessorClasses" style="cursor:pointer"><small>Somente
                                                turmas do professor</small></label>
                                    </div>
                                    <div>
                                        <input id="checkAllClasses" name="allClasses" type="checkbox"
                                            onchange="onChangeAllClasses(event)">
                                        <label for="checkAllClasses" style="cursor:pointer"><small>Turmas de todos os
                                                professores</small></label>
                                    </div>
                                </div>
                            ...
                            <div id="dadosDisciplina" class="mt-2 d-none container py-2 d-none" ,
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="progress">
                                            <div id="progressAprovados" class="progress-bar bg-success"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="progress">
                                            <div id="progressReprovados" class="progress-bar bg-danger"
                                                role="progressbar" style="width: 0%" aria-valuenow="25"
                                                aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-2" style="background-color:azure">
                                    <strong class="col-6 mb-0 text-primary">Nota média<small
                                            class="text-secondary">&nbsp;(todas as unidades)</small></strong>
                                    <div class="col-6 d-flex justify-content-end">
                                        <strong id="notaMediaComponente" class="text-primary">0</strong>
                                    </div>
                                </div>

                                <div id="notasPorUnidade" class="row mt-2"
                                    style="border: 1px solid rgba(0,0,0,0.2); border-radius:5px"><!--Notas das unidades-->
                                    <div class="col-md-12">
                                        <strong class="text-secondary">Nota média por unidade</strong>
                                    </div>
                                    <div class="col-md-4 pb-3"
                                        style="box-sizing:border-box; border-radius:10px; box-shadow:2px 2px 5px rgba(0,0,0,0.2)">
                                        <div class="row">
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="progress">
                                                            <div id="progressNotaUnidade1" class="progress-bar bg-primary"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="progress">
                                                            <div id="progressNotaUnidade2" class="progress-bar bg-primary"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="progress">
                                                            <div id="progressNotaUnidade3" class="progress-bar bg-primary"
                                                                role="progressbar" style="width: 42%" aria-valuenow="25"
                                                                aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        @if (count($discipline->subjectTopics) > 3)
                                            <a id="seeMoreTopics" class="link" data-toggle="collapse"
                                                href="#collapseTopics" role="button" aria-expanded="false"
                                ...
                                <div class="card mt-2">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        @if (count($discipline->subjectConcepts) > 3)
                                            <a id="seeMoreConcepts" class="link" data-toggle="collapse"
                                                href="#collapseConcepts" role="button" aria-expanded="false"
                                                aria-controls="collapseConcepts">
                                                ver mais
                                            </a>
                                        @endif
                                    </div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        @if (count($discipline->subjectReferences) > 3)
                                            <a id="seeMoreReferences" class="link" data-toggle="collapse"
                                                href="#collapseReferences" role="button" aria-expanded="false"
                ...
                @if (auth()->user())
                    ...
                    @if (
                        (Auth::user() && Auth::user()->professor && Auth::user()->professor->id == $discipline->professor->id) ||
                            Auth::user())
                        <button class="btn btn-success btn-sm mt-4" data-toggle="modal"
                            data-target="#modal-cadastro-metodologia" onclick="openModalAddMethodologies()">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        <div class="row">
                                            <div class='col-md-12'>
                                                <button class="btn btn-primary btn-sm mb-2" style='cursor:pointer;'
                                                    data-toggle="collapse" data-target="#collapse-criar-metodologia"
                                                    onclick="clearCreateMethodologyInputs()">
                                            ...
                                            <div class='col-md-12 mb-4'>
                                                <div id='collapse-criar-metodologia' class='collapse' class='form-group'>
                                                    <label class="text-secondary" for="nome-nova-metodologia">Nome da
                                                        metodologia</label>
                                                    <input id="nome-nova-metodologia" type='text'
                                                        class='form-control mb-1'>
                                                    <label class="text-secondary"
                                                        for="descricao-nova-metodologia">Descrição da metodologia</label>
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-md-12'>
                                                <small><strong id="feedback-add-methodology"
                                                        class="d-none text-danger form-text">
                ...
                @if (!auth()->user())
                    @if (count($discipline->professor_methodologies) > 0)
                        @foreach ($discipline->professor_methodologies as $professorMethodology)
                            <strong class='badge badge-primary mr-2' style='cursor:pointer;' data-toggle='modal'
                                data-target="{{ '#modal-methodology' . $professorMethodology->id }}">
                                <i class="fas fa-regular fa-hand-pointer click-me"></i>
                                {{ $professorMethodology->methodology->name }}
                            </strong>
                            <div class='modal fade' tabindex='-1' role='dialog'
                                id="{{ 'modal-methodology' . $professorMethodology->id }}">
                                <div class='modal-dialog' role='document'>
                                    <div class='modal-content'>
                                        <div class="modal-header">
                                            <h3 class='modal-title text-primary'>
                                                {{ $professorMethodology->methodology->name }}</h3>
                                            ...
                                            <div class='d-flex flex-column'>
                                                ...
                                                @if (isset($professorMethodology->professor_description) && $professorMethodology->professor_description != '')
                                                    <p class='text-primary'>
                                                        {{ $professorMethodology->professor_description }}</p>
                                                @else
                                                    <p class='text-primary'>
                                                        {{ $professorMethodology->methodology->description }}</p>
                                                @endif
                                            </div>
                                            @if ($professorMethodology->methodology_use_description && $professorMethodology->methodology_use_description != '')
                                                ...
                                                <div class='d-flex flex-column'>
                                                    <small class='text-secondary'>Como o professor aplica a
                                                        metodologia</small>
                                                    <p class='text-primary'>
                                                        {{ $professorMethodology->methodology_use_description }}</p>
                                                </div>
                                            @endif
                            ...
                            <div class='modal-body'>
                                <div class='d-flex flex-column'>
                                    <div class='d-flex justify-content-end'>
                                        <button id="btn-remove-methodology" class='btn btn-outline-danger btn-sm'
                                            onclick='removeProfessorMethodology()'>
                                            Remover metodologia
                                        </button>

                                        <button id="btn-delete-methodology" class='btn btn-danger btn-sm ml-2'
                                            onclick='deleteMethodology()'>
                                            Apagar metodologia
                                        </button>
                                    ...
                                    <small class='text-secondary'>Descrição da metodologia</small>
                                    <textarea id='methodology-description' rows='9' class='text-primary'
                                        placeholder="Descreva como é essa metodologia"></textarea>
                                    <textarea id='professor-methodology-description' rows='9' class='text-primary d-none'
                                        placeholder="Descreva como é esta metodologia"></textarea>
                                    <div id='feedback-methodology' class='d-none alert  mt-2'>
                                        <span id='feedback-methodology-message' style='text-align:center'>Erro ao
                                            atualizar</span>
                                        <button class='close'
                                            onclick="closeAlert('feedback-methodology')">&times</button>
                                    </div>
                                </div>
                                <hr>
                                <div class='d-flex flex-column'>
                                    <small class='text-secondary'>Como o professor aplica a metodologia</small>
                                    <textarea id='methodology-use-description' class='text-primary' rows='10' class="text-primary"
                                        placeholder="Descreva como você aplica esta metodologia"></textarea>
                                    <div id='feedback-professor-methodology' class='d-none alert  mt-2'>
                                        <span id='feedback-professor-methodology-message' style='text-align:center'>Erro
                                            ao atualizar</span>
                                        <button class='close'
                                            onclick="closeAlert('feedback-professor-methodology')">&times</button>
                                    </div>
                                </div>
                            </div>
                            <div class='modal-footer'>
                ...
                <div class="section">
                    ...
                    <form id="formDuvida" action="https://formsubmit.co/eugenio@imd.ufrn.br" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id='studentEmail' name='Email do estudante' class="form-control"
                                placeholder="Digite seu email" required>
                        </div>
                        <div class="form-group">
                            <label for="studentQuestion">Título</label>
                            <input type='text' id='studentQuestion' name='Título da pergunta' class="form-control"
                        ...
                        <input type="hidden" name="_next"
                            value='https://portaldasdisciplinas.imd.ufrn.br/disciplinas/{{ $discipline->id }}'>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="wrapper-teacher-info">
                                            <div class="text-justify px-lg-3">
                                                <strong>{{ $discipline->professor->name }}</strong> </div>
                                            ...
                                            @else
                                                <a href="{{ $discipline->professor->link_rsocial1 }}"
                                                    class="text-justify px-lg-3"> <strong>
                                                        {{ $discipline->professor->rede_social1 }} </strong></a>
                                            @endif
                                            @if ($discipline->professor->rede_social2 == '')
                                                <div class=" p-text"></div>
                                            @else
                                                <a href="{{ $discipline->professor->link_rsocial2 }}"
                                                    class="text-justify px-lg-3">
                                                    <strong>{{ $discipline->professor->rede_social2 }}</strong></a>
                                            @endif
                                            @if ($discipline->professor->rede_social3 == '')
                                                <div class=" p-text"></div>
                                            @else
                                                <a href="{{ $discipline->professor->link_rsocial3 }}"
                                                    class="text-justify px-lg-3">
                                            ...
                                            @if ($discipline->professor->rede_social4 == '')
                                                <div class=" p-text"></div>
                                            @else
                                                <a href="{{ $discipline->professor->link_rsocial4 }}"
                                                    class="text-justify px-lg-3">
                    ...
                    <div class="d-flex flex-column shadow p-2 align-items-start">
                        <div class="d-flex flex-row justify-content-start align-items-baseline">
                            ...
                            @if (Auth::user() && Auth::user()->isAdmin)
                                <button class="btn btn-success btn-sm ml-3 mb-4" data-toggle="modal"
                        ...
                        @foreach ($discipline->disciplineParticipants as $participant)
                            <div id="collapseCreditos" class="collapse w-100">
                                <div id="" class="d-flex flex-column mb-4" style="line-height:1.2">
                                    <div
                                        class="d-flex flex-row align-items-center justify-content-between w-100 bg-pridmary">
                                        <span class=" d-flex w-100 justify-content-between">
                                            <strong class="" style="cursor:pointer" data-toggle="collapse"
                                                data-target="#linksCollapse{{ $participant->id }}">
                                                {{ $participant->name }}
                                        ...
                                        @if (Auth::user() && Auth::user()->isAdmin)
                                            <div class="d-flex align-items-center">
                                                <button class="ml-1  btn btn-link" id="{{ $loop->index }}"
                                                    onclick="openModalEdit(event)" data-toggle="modal"
                                                    data-target="#modal-edit">editar</button>
                                                <form class=""
                                                    action="{{ route('participants_discipline.destroy', $participant->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class=" mr-0 p-0 text-danger btn btn-link"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('participants_discipline.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="role" name="role" type="text"
                                placeholder="Função do participante nesta disciplina" maxlength=20 required>
                        </div>
                        <div class="form-group">
                    ...
                    <button id="add-link-field" class="btn btn-outline-primary btn-sm"
                        onclick="addLinkField('modal-add')">Adicionar Link</button>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('participants_discipline.update') }}">
                        ...
                        <div class="form-group">
                            <label for="role">Função</label>
                            <input class="form-control" id="role" name="role" type="text"
                                placeholder="Função do participante desta disciplina" maxlength=30 required>
                        </div>
                        <div class="form-group">
                            <label for="role">E-mail</label>
                            <input class="form-control" id="email" name="email" type="email"
                    ...
                    <button id="add-link-field" onclick="addLinkField('modal-edit')"
                        class="btn btn-outline-primary btn-sm">Adicionar Link</button>
                </div>
                <div class="modal-footer">
        ...
        function renderLinks(idModal) {
            ...
            for (var i = 0; i < links.length; i++) {
                html += "<div class='form-group'>" +
                    ...
                    "<label id='" + i + "' class='btn btn-link mb-4 mt-0 p-0' " + "onclick='deleteFieldLink(event,\"" +
                    idModal + "\")'" + "> remover </label>" +
                    "</div>";
            }
