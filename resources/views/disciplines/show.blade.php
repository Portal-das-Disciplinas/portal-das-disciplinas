        ...
        <div class="">
            <div class="d-flex align-items-center">
                ...
                <div class="wrapper-teacher-info">
                    ...
                    <div class="text-justify px-lg-3"> <strong>Email: </strong>{{ $discipline->professor->public_email
                        }} </div>
                    <div class="text-justify px-lg-3"> <a href="{{$discipline->professor->public_link}}"
                            target="_blank"> Página do professor</a> </div>
                </div>
